...
all:
	...
	${CC} -g -lm -o ./bin/feature_scale ./src/feature_scale.c
...
debug:
	...
	${CC} -D DEBUG -g -lm -o ./bin/feature_scale ./src/feature_scale.c
...
timer:
	...
	${CC} -D TIMER -g -lm -o ./bin/feature_scale ./src/feature_scale.c
...
release:
	...
	${CC} -o -lm ./bin/feature_scale ./src/feature_scale.c
